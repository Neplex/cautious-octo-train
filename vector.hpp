...
public:
   ...
   */
  Vector(unsigned int const _size) : size(_size), element(new float[_size]) {}
   ...
   * \return A new vector whose coordinates are the sum of the coordinate of
   * this and v.
   */
   ...
   * \pre this and v have the same size.
   * \return A new vector whose coordinates are the subtractions of the
   * coordinate of v from the ones of this.
   */
  Vector operator-(Vector const &v) const;

  /*! Compute the product of the vector by a scalar a.
   * \param a Float to multiply by.
   * \return A new vector whose coordinates are the product of the coordinate of
   * this and a.
   */
  ...
  friend Vector operator*(float const a, Vector const &v);

  friend std::ostream &operator<<(std::ostream &ost, Vector const &v);
};

/*! Multiplication by a scalar function.
 * \param a Float to multiply by.
 * \param v Vector to multiply.
 * \return A new vector whose coordinates are the product of the coordinates of
 * v by a.
 */
